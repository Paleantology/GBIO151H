...
Welcome to Bio151H! This semester, we will discuss the fundamental principles that underly the amazing breadth of animals, plants, and microbes that we see on Earth.
...
```
masses <- read_csv("BodyMassData.csv")
```
...
```
ggplot(final, mapping = aes(x = Latitude, y = Mass)) +
    geom_point() 
