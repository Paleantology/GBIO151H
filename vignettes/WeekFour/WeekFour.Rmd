...
Today, we will install a search functiont to access the federal databases, and we will use them to understand how molecular identification of viruses works. 
...
```{r, results = 'hide' }
library(Biostrings)
mystery_seq <- readDNAStringSet("data/MysterVirus.fasta")
```
